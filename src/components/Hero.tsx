...
export function Hero(props: any) {
	...
	}, [props.item.first_air_date, props.item.release_date]);
		...
		<div>
			<div className={styles.hero}>
				<div className={styles.backdrop}>
					<div>
						{props.trailer && (
							<button className={styles.play} type='button' aria-label='Play Trailer'>
								{/* <CirclePlayIcon /> */}
							</button>
						)}
						<picture>
            ...
            { props.item.name }
						...
						<div className={styles.meta}>
							...
							<div className={styles.info}>
								...
								{props.item.runtime && <span>{formatRuntime(props.item.runtime)}</span>}
								{/* <span>Cert. {{ cert }}</span> */}
							</div>
						</div>
