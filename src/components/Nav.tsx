  ...
  return (
    <nav className={styles.nav}>
      <ul className="nolist">
        ...
        <li>
          <Link className={pathname === '/' ? 'active' : ''} href="/" aria-label="Home">
            <AiOutlineHome style={{ width: '24px', height: '24px' }} />
          </Link>
        </li>
        <li>
          <Link className={pathname === '/movie' ? 'active' : ''} href="/movie" aria-label="Movies">
            <LuClapperboard style={{ width: '24px', height: '24px' }} />
          </Link>
        </li>
        <li>
          <Link className={pathname === '/tv' ? 'active' : ''} href="/tv" aria-label="TV Shows">
            <PiTelevisionSimpleBold style={{ width: '24px', height: '24px' }} />
          </Link>
        </li>
        <li>
          <Link className={pathname === '/search' ? 'active' : ''} href="/search" aria-label="Search">
